...
curl --proto '=https' --tlsv1.2 -LsSf https://github.com/HaoZeke/rsx-rs/releases/download/v0.2.10/rsx-cli-installer.sh | sh
```
...
For the software itself (v0.2.10), prefer the GitHub Cite button, the `CITATION.cff`, or the Zenodo DOI entry (generated from the deposit page). The reproducibility archive has its own Zenodo-generated BibTeX.
