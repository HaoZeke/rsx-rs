...
| Numerical/statistical routines | =radsex-core/tests/test_precision.rs= and =radsex-core/src/stats.rs= unit tests |
| Command behavior | =radsex-core/tests/test_pipeline.rs= integration tests |
...
| =MarkerTableSource= parity (file / Arrow / Parquet) | =radsex-core/src/source/tests.rs= and =rsx-python/tests/test_marker_table_from_arrow.py= (including the =RSX_FORCE_SPILL=1= toggle test) |
