...
|---------+------------+--------------+--------------+---------|
| process | 3.6x       | 2.5x         | --           | 3.1x    |
| freq    | 4.0x       | 2.0x         | 1.9x         | 2.6x    |
| depth   | 4.3x       | 2.6x         | 2.9x         | 3.3x    |
| distrib | 5.3x       | 3.9x         | 2.5x         | 3.9x    |
| signif  | 3.2x       | 1.9x         | 2.1x         | 2.4x    |
| subset  | 4.0x       | 2.0x         | 2.3x         | 2.8x    |
| map     | 2.1x       | 1.6x         | --           | 1.9x    |
...
*Rust is 2.19x faster* across all 19 benchmarks (1.896s vs 0.864s total).
