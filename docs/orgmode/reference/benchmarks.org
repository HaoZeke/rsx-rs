...
is faster in 49 pairs. The geometric-mean speedup is 6.81x when speedup is
defined as C++ wall time divided by Rust wall time. The process-stage
geometric-mean speedup is 2.47x across the four literature datasets.
=depth=, =freq=, and =distrib= favor rsx-rs in every paired run, with
geometric-mean speedups of 5.43x, 19.29x, and 21.40x, respectively.
=signif= is mixed: rsx-rs is faster in 9 of 16 paired runs, with a 1.04x
