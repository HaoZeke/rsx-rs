...
Across 56 paired command/dataset/depth timings, rsx-rs is faster in 54
pairs. The geometric-mean speedup is 8.91x. Process-stage speedup is 2.09x
geometric mean across the four literature datasets. =freq= and =distrib=
show 26.35x and 29.76x geometric-mean speedups, respectively. =signif=
is closer: 1.38x geometric mean, with two =plecoglossus_altivelis= depth
rows where C++ is slightly faster.
